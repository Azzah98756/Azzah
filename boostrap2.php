...
<img src="img/e.jpg" width="130" height="100">  
...
<h5>Produk 2</h5> <p>Some representative placeholder content for the first slide.</p>
 ...
 <img src="img/jus.jpg" class="d-block w-100" alt="...">
<div class="carousel-caption d-none d-md-block"> 
<h5>Produk 3</h5> 
<p>Some representative placeholder content for the first slide.</p> 
</div>
...
<img src="img/e.jpg" class="img-fluid img-thubnail" alt="">
</div> 
...
<img src="img/e.jpg" class="card-img-top" class="card-img-top" 	alt="...">
  <div class="card-body">
...
<div class="col-3">
    <div class="card">
   <img src="img/jus.jpg" class="card-img-top" class="card-img-top" 	alt="...">
  <div class="card-body">
    <h5 class="card-title">Cake Coklate</h5>
...
<div class="col-3">
   <div class="card">
   <img src="img/Donat.jpg" class="card-img-top" class="card-img-top" 	alt="...">
